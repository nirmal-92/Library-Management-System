...
const Header = ({
  ...
  const onLogout = () => {
    // Optional: clear auth data here
    navigate('/login'); // ✅ Proper logout redirect
  };
        ...
        <div className="flex space-x-2 ml-auto justify-end">
          ...
          <div className="relative inline-block" ref={dropdownRef}>
            ...
            <div className={`absolute z-10 mt-2 w-52 bg-white shadow-lg rounded-md ${isDropdownOpen ? 'block' : 'hidden'} transition duration-300 transform-gpu origin-top`}>
              <div className="py-1">
                <button onClick={onAddBookClick} className="block w-full text-left px-2 py-1 text-gray-800 hover:bg-gray-200">
          ...
          <div className="relative inline-block text-left" ref={deleteDropdownRef}>
            ...
            <div className={`absolute z-10 mt-2 w-48 bg-white shadow-lg rounded-md ${isDeleteDropdownOpen ? 'block' : 'hidden'} transition duration-300 transform-gpu origin-top`}>
              <div className="py-1 text-left">
          ...
          {/* Logout Button */}
          <button onClick={onLogout} className="bg-blue-600 text-white px-4 mb-2 rounded font-semibold hover:bg-blue-500 focus:ring-4 focus:ring-blue-400">
            Logout
          </button>
        </div>
      </div>
